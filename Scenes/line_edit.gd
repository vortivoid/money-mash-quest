...
var secret_names = {
	...
	"No fucking way it's the person who made me wtffffff???": ["vorti", "vortivoid"],
	"I SEE YOU.": ["charliecringe"],
	"Shouldn't you be like, sailing the seas and discussing the economy?": ["longingstring", "longingstring65"],
	"no way it's DrAgOn Ninja XYZmoc The Meme Thief!!1!": ["zmoc"],
	"Cheese Graters, Beans, and a Bin(fx). What more could one want?": ["finnfx", "binfx"],
	"Second-hand automobile skyscraper stick insect rug": ["cosmo", "derser", "furrsa", "rug"],
	...
	"There's no point saying anything, you won't read this anyway": ["goaty", "0goaty0", "goatyno"],
	"Ooooo you like kissing boys you're a furry femboy boykisser ooooo": ["revqn", "revqnyt"],
	"fortnite": ["fortnite"],
	"Do not fuck the kitchenware": ["katethepanplate", "thepanplate"],
	...
	"...i hate you": ["legends77", "legends77yt", "seppy", "theseptenary", "theseventhlegend"],
	"I know": ["iloveyou"],
	...
	":3": [":3"],
	"Fuckin' furry": [">w<", "owo"],
	"Fuckin' weeb": ["uwu", "anime", "senpai", "oniichan", "onii-chan"],
	...
	"MY MOTHER?!": ["yourmum", "yourmother", "yourmom", "birthlady"], #Finn why
	"FINN REFERENCE?!?!?!": ["shark"],
	"Looking cool, Joker": ["joker"],
	"The true name.": ["chara"],
	"C₁₈H₂₄O₂": ["maxi", "itsmaximaxi"],
	"Don't burn those eggs now": ["lotta", "lottaspider"],
	"Get back on Hypixel nerd >:3": ["kada" ,"kada002"],
	"This easter egg is pissing me off": ["starwalker"]
}
